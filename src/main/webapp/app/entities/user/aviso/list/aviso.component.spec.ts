...
describe('Aviso Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'aviso', component: AvisoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.avisos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to avisoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAvisoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAvisoIdentifier).toHaveBeenCalledWith(entity);
