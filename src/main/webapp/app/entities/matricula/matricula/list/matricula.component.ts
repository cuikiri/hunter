...
import { IDadosPessoais, DadosPessoais } from '../../../user/dados-pessoais/dados-pessoais.model';
...
export class MatriculaComponent implements OnInit {
  ...
  trackId(_index: number, item: IMatricula): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IMatricula[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
