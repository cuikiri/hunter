...
export class PautaComponent implements OnInit {
  ...
  trackId(_index: number, item: IPauta): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IPauta[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
