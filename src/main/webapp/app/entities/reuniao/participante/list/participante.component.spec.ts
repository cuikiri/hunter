...
describe('Participante Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'participante', component: ParticipanteComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to participanteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getParticipanteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getParticipanteIdentifier).toHaveBeenCalledWith(entity);
