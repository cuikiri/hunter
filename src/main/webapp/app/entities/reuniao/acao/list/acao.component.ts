...
export class AcaoComponent implements OnInit {
  ...
  trackId(_index: number, item: IAcao): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IAcao[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
