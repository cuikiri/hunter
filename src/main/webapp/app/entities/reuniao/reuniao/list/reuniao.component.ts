...
import { EntityArrayResponseType, ReuniaoService } from '../service/reuniao.service';
...
export class ReuniaoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IReuniao): number => this.reuniaoService.getReuniaoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.reuniaos = this.refineData(dataFromBody);
  }

  protected refineData(data: IReuniao[]): IReuniao[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IReuniao[] | null): IReuniao[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.reuniaoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
